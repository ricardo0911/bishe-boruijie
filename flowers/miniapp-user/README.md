...
- 默认：`http://127.0.0.1:18080/api/v1`
- 如需修改，在 `app.js` 的 `globalData.apiBase` 调整
- 如果你用手机真机预览，`127.0.0.1` 不可用，请改为电脑局域网 IP（如 `http://192.168.1.10:18080/api/v1`）
...
- 登录改为**账号密码模式**：首次使用需注册账号，之后通过 `/users/login` 登录，并可在“我的”页修改密码
