  ...
  <div>
    ...
    <div class="card">
      ...
      <div class="card-body" style="display:flex;gap:12px;flex-wrap:wrap">
        <router-link to="/users" class="btn btn-outline">用户管理</router-link>
        <router-link to="/merchants" class="btn btn-outline">商家管理</router-link>
        <router-link to="/orders" class="btn btn-outline">订单管理</router-link>
        <router-link to="/config" class="btn btn-outline">系统配置</router-link>
      </div>
    </div>
  </div>
</template>
