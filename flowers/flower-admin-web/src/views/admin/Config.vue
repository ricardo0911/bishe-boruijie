        ...
        <div class="table-wrapper">
          <table>
            <tbody>
              ...
              <tr><td style="font-weight:500">API 文档</td><td><a href="http://localhost:18080/swagger-ui/index.html" target="_blank" style="color:var(--primary)">Swagger UI</a></td></tr>
              <tr><td style="font-weight:500">健康检查</td><td><a href="http://localhost:18080/actuator/health" target="_blank" style="color:var(--primary)">/actuator/health</a></td></tr>
            </tbody>
          </table>
        </div>
      </div>
